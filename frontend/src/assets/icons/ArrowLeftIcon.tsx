...
function SvgComponent({ size = 20, color = "black" }: IconBase): JSX.Element {
  return (
    <Svg testID="icon-arrow-left" width={size} height={size} viewBox="0 0 20 20" preserveAspectRatio="xMidYMid meet">
      <Path
        fillRule="evenodd"
        clipRule="evenodd"
